...
<script>
    ...
    setInterval(function() {
        ...
        $.ajax({
            type: "GET",
            url: "http://161.117.253.209/smartmonitoring/api/monitoring/GetData.php?lokasi_id=2",
        ...
        $.ajax({
            type: "GET",
            url: "http://161.117.253.209/smartmonitoring/api/chart/GetDataMingguan.php?lokasi_id=2&kategori=" + document.getElementById('ddlFilterLineChart1').value,
            contentType: "application/json; charset=utf-8",
            data: {},
            dataType: "json",
            success: function(msg) {
        ...
        $.ajax({
            type: "GET",
            url: "http://161.117.253.209/smartmonitoring/api/chart/GetDataTahunan.php?lokasi_id=2&kategori=" + document.getElementById('ddlFilterLineChart1').value,
            contentType: "application/json; charset=utf-8",
            data: {},
            dataType: "json",
