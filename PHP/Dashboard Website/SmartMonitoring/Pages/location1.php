...
<script>
    ...
    setInterval(function() {
        ...
        $.ajax({
            type: "GET",
            url: "http://localhost:7788/smartmonitoring/api/monitoring/GetData.php?lokasi_id=1",
        ...
        $.ajax({
            type: "GET",
            url: "http://localhost:7788/smartmonitoring/api/chart/GetDataMingguan.php?lokasi_id=1&kategori=" + document.getElementById('ddlFilterLineChart1').value,
            contentType: "application/json; charset=utf-8",
            data: {},
            dataType: "json",
            success: function(msg) {
        ...
        $.ajax({
            type: "GET",
            url: "http://localhost:7788/smartmonitoring/api/chart/GetDataTahunan.php?lokasi_id=1&kategori=" + document.getElementById('ddlFilterLineChart1').value,
            contentType: "application/json; charset=utf-8",
            data: {},
            dataType: "json",
